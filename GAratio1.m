% GAtemp1 stands for 3stage single-ended CMOS Ring Oscillator for Rise/Fall Time Ratio in each inverter    , 'c2.sp' ,    with
% GA
clc;
tic;
clear;
...
CostFunction=@GAratio2;     % Cost Function
...
xlabel('Iteration');
ylabel('Best Fitness = Best Asymmetrical Rise/Fall Time Ratio');
toc;